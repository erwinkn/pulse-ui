...
<PyAttribute name={"react_server_address"} type={"str"} value={"react_server_address"} />

<PyAttribute name={"server_address"} type={"str"} value={"server_address"} />

<PyAttribute name={"client"} type={"httpx.AsyncClient"} value={null}>
...
<PyFunction name={"__init__"} type={"(self, react_server_address, server_address)"}>
...
<PyParameter name={"react_server_address"} type={"str"} value={null} />
...
<PyFunction name={"rewrite_url"} type={"(self, url) -> str"}>
...
<PyFunction name={"_is_websocket_upgrade"} type={"(self, request) -> bool"}>
...
<PyFunction name={"_http_to_ws_url"} type={"(self, http_url) -> str"}>
...
<PyParameter name={"self"} type={null} value={null} />
<PyParameter name={"http_url"} type={"str"} value={null} />
...
<PyFunction name={"proxy_websocket"} type={"(self, websocket) -> None"}>
...
<PyParameter name={"self"} type={null} value={null} />
<PyParameter name={"websocket"} type={"WebSocket"} value={null} />
...
<PyFunction name={"__call__"} type={"(self, request) -> Response"}>
...
<PyFunctionReturn type={"starlette.responses.Response"} />
