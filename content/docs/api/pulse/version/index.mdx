...
<PyAttribute name={"__all__"} type={null} value={"['__version__']"} />

<PyAttribute name={"__version__"} type={"str"} value={"_version()"} />

<Tabs items={["Functions"]}>

<Tab value={"Functions"}>

<PyFunction name={"_read_local_pyproject_version"} type={"() -> str | None"}>
...
<PyFunction name={"_version"} type={"() -> str"}>
