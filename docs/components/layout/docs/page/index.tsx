...
export function DocsPage({
	...
	const tocTitle = (
		// biome-ignore lint/correctness/useUniqueElementIds: Used by global docs styles.
		<h3
			id="toc-title"
	...
	const article = (
		// biome-ignore lint/correctness/useUniqueElementIds: Public hooks for page-level styling.
		<article
			id="nd-page"
			data-full={full}
			className={cn(
