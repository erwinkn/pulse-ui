...
Pulse uses client-side routing to create fast, seamless navigation between pages. Routes are defined on your `App` and rendered with the Pulse client router.
