...
<Card title={"VersionConflict"} href={"/docs/api/pulse/cli/packages/VersionConflict"} />
...
<PyFunction name={"is_relative_source"} type={"(src) -> bool"}>
...
<PyFunction name={"is_alias_source"} type={"(src) -> bool"}>
...
<PyFunction name={"is_url_or_absolute"} type={"(src) -> bool"}>
...
<PyFunction name={"parse_dependency_spec"} type={"(spec) -> tuple[str, str | None]"}>
...
<PyFunctionReturn type={"tuple[str, str | None]"} />

</PyFunction>
<PyFunction name={"parse_install_spec"} type={"(src_or_spec) -> str | None"}>
...
<PyParameter name={"src_or_spec"} type={"str"} value={null} />
...
<PyFunction name={"pick_more_specific"} type={"(a, b) -> str | None"}>
...
<PyParameter name={"a"} type={"str | None"} value={null} />
<PyParameter name={"b"} type={"str | None"} value={null} />
...
<PyFunction name={"resolve_versions"} type={"(constraints) -> dict[str, str | None]"}>
...
<PyParameter name={"constraints"} type={"dict[str, list[str | None]]"} value={null} />
...
<PyFunction name={"load_package_json"} type={"(web_root) -> dict[str, Any]"}>
...
<PyFunction name={"get_pkg_spec"} type={"(pkg_json, name) -> str | None"}>
...
<PyParameter name={"pkg_json"} type={"dict[str, Any]"} value={null} />
...
<PyFunction name={"is_workspace_spec"} type={"(spec) -> bool"}>
...
<PyFunction name={"_split_constraint"} type={"(spec) -> tuple[str, str | None]"}>
...
<PyFunction name={"_parse_major_minor"} type={"(ver) -> tuple[int | None, int | None]"}>
...
<PyParameter name={"ver"} type={"str | None"} value={null} />

</div>

<PyFunctionReturn type={"tuple[int | None, int | None]"} />

</PyFunction>
<PyFunction name={"spec_satisfies"} type={"(required, existing) -> bool"}>
...
<PyParameter name={"required"} type={"str | None"} value={null} />
<PyParameter name={"existing"} type={"str | None"} value={null} />
