...
<PyFunction name={"_get_import_src"} type={"(imp) -> str"}>
...
<PyParameter name={"imp"} type={"Import"} value={null} />
...
<PyFunction name={"_generate_import_statement"} type={"(src, imports) -> str"}>
...
<PyParameter name={"src"} type={"str"} value={undefined}>

The original source path (may be remapped for local imports)

</PyParameter>
<PyParameter name={"imports"} type={"list[Import]"} value={undefined}>

List of Import objects for this source
...
<PyFunction name={"_generate_imports_section"} type={"(imports) -> str"}>
...
<PyParameter name={"imports"} type={"Sequence[Import]"} value={undefined}>

List of Import objects to generate (should be eager imports only)
...
<PyFunction name={"_generate_lazy_imports_section"} type={"(imports) -> str"}>
...
<PyFunction name={"_generate_constants_section"} type={"(constants) -> str"}>
...
<PyParameter name={"constants"} type={"Sequence[Constant]"} value={null} />
...
<PyFunction name={"_generate_functions_section"} type={"(functions) -> str"}>
...
<PyParameter name={"functions"} type={"Sequence[AnyJsFunction]"} value={null} />
...
<PyFunction name={"_generate_registry_section"} type={"(imports, constants, functions) -> str"}>
...
<PyParameter name={"imports"} type={"Sequence[Import]"} value={null} />
<PyParameter name={"constants"} type={"Sequence[Constant]"} value={null} />
<PyParameter name={"functions"} type={"Sequence[AnyJsFunction]"} value={null} />
...
<PyFunction name={"generate_route"} type={"(path, route_file_path) -> str"}>
...
<PyParameter name={"route_file_path"} type={"str"} value={undefined}>

Path from pulse root (e.g., "routes/users/index.tsx")
