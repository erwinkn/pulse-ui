...
<PyAttribute name={"Primitive"} type={null} value={"int | float | str | bool | None"} />

<PyAttribute name={"PlainJSON"} type={null} value={"Primitive | list['PlainJSON'] | dict[str, 'PlainJSON']"} />

<PyAttribute name={"Serialized"} type={null} value={"tuple[tuple[list[int], list[int], list[int], list[int]], PlainJSON]"} />

<PyAttribute name={"__all__"} type={null} value={"['serialize', 'deserialize', 'Serialized']"} />

<Tabs items={["Functions"]}>

<Tab value={"Functions"}>

<PyFunction name={"serialize"} type={"(data) -> Serialized"}>
...
<Callout title={"Supported types"} type={"supported-types"}>
...
<PyFunctionReturn type={"pulse.serializer.Serialized"}>
...
<PyFunction name={"deserialize"} type={"(payload) -> Any"}>
...
<PyParameter name={"payload"} type={"Serialized"} value={undefined}>

Serialized tuple from serialize().
...
<PyFunction name={"_datetime_to_millis"} type={"(value) -> int"}>
...
<PyParameter name={"value"} type={"dt.datetime"} value={null} />
...
<PyFunction name={"_datetime_from_millis"} type={"(value) -> dt.datetime"}>
...
<PyParameter name={"value"} type={"int | float"} value={null} />

</div>

<PyFunctionReturn type={"datetime.datetime.datetime"} />
