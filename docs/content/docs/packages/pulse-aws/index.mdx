...
You should now see checks for the base URL, health endpoint, and (if multiple versions exist) query-based affinity routing for existing sessions via `/_pulse/deployment`.
