...
| `--cdk-bin` | `PULSE_AWS_CDK_BIN` | `cdk` | CDK executable or wrapper path |
| `--cdk-workdir` | `PULSE_AWS_CDK_WORKDIR` | packaged `pulse_aws/cdk` app | advanced override for a custom CDK app |
