...
Unified channel envelope. Discriminated on `action`.
...
interface ChannelConnectMessage extends ChannelMessageBase {
  action: "connect";
  subscriptionId: string;
  owner?: string;
}

interface ChannelDisconnectMessage extends ChannelMessageBase {
  action: "disconnect";
  subscriptionId: string;
  owner?: string;
}

interface ChannelEventMessage extends ChannelMessageBase {
  action: "event";
  event: string;
  payload?: any;
  subscriptionId?: string;
...
interface ChannelRequestMessage extends ChannelMessageBase {
  action: "request";
  event: string;
  requestId: string;
  payload?: any;
...
interface ChannelResponseMessage extends ChannelMessageBase {
  action: "response";
  responseTo: string;
  payload?: any;
  error?: any;
...
```ts
interface ChannelConnectAckMessage extends ChannelMessageBase {
  action: "connect_ack";
  subscriptionId: string;
  accepted: boolean;
  error?: string;
...
interface ChannelCloseMessage extends ChannelMessageBase {
  action: "close";
  subscriptionId: string;
  reason?: string;
}
