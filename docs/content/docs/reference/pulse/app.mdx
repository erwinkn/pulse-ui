...
| `pending_timeout` | `float` | `60.0` | How long unclaimed work survives before being released: pending route mounts awaiting first attach, and render sessions left with no mounts (seconds) |
