...
| `name` | `str \| None` | `None` | Diagnostic name. State methods default to the class member name; standalone computeds default to the callable name. Does not affect member identity. |
