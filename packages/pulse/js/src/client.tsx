...
export class PulseSocketIOClient {
  ...
  public async connect(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      // Build auth object from directives and renderId
      const auth: Record<string, string> = { renderId: this.#renderId };
      if (this.#directives?.socketAuth) {
        Object.assign(auth, this.#directives.socketAuth);
      }
