...
describe("VDOMRenderer", () => {
	...
	it("handles multiple ref channels across renderers", () => {
		...
		const channelsA = createPulseChannelManager(shared.client, "/a");
		const channelsB = createPulseChannelManager(shared.client, "/b");
		const rendererA = new VDOMRenderer(shared.client, channelsA, "/a", {});
		const rendererB = new VDOMRenderer(shared.client, channelsB, "/b", {});
