...
def assert_(condition: bool, *data: object) -> None: ...
def clear() -> None: ...
def count(label: str | None = None) -> None: ...
def countReset(label: str | None = None) -> None: ...
def debug(*data: object) -> None: ...
def dir(item: object, options: dict[str, Any] | None = None) -> None: ...
def dirxml(*data: object) -> None: ...
def error(*data: object) -> None: ...
def group(*label: object) -> None: ...
def groupCollapsed(*label: object) -> None: ...
def groupEnd() -> None: ...
def info(*data: object) -> None: ...
def log(*data: object) -> None: ...
def table(tabularData: object, properties: list[str] | None = None) -> None: ...
def time(label: str | None = None) -> None: ...
def timeEnd(label: str | None = None) -> None: ...
def timeLog(label: str | None = None, *data: object) -> None: ...
def trace(*data: object) -> None: ...
def warn(*data: object) -> None: ...


# Self-register this module as a JS builtin
register_js_module(name="console")
