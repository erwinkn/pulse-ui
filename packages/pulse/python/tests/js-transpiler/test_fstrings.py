...
def test_format_spec_errors():
	...
	try:
		...
		raise AssertionError("Expected JSCompilationError for non-constant format spec")
	...
	try:
		...
		raise AssertionError("Expected JSCompilationError for unsupported type")
	except JSCompilationError as e:
	...
	try:
		...
		raise AssertionError("Expected JSCompilationError for unsupported grouping")
	except JSCompilationError as e:
	...
	try:
		...
		raise AssertionError("Expected JSCompilationError for '=' alignment on string")
	except JSCompilationError as e:
