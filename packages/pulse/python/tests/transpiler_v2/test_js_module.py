"""Tests for pulse.js.* module integration in transpiler_v2."""
...
from pulse.transpiler_v2.js_module import Class
...
def clear_caches() -> Iterator[None]:
	...
	# registrations (e.g. pulse.js2.* modules registering ModuleRef).
...
class TestNew:
	...
	def test_emit_with_args(self) -> None:
		"""New emits with args."""
		from pulse.transpiler_v2 import Array, Literal
