...
class TestGenerateRouteWithRegistry:
    ...
    def test_route_with_no_components(self):
        ...
        initial_tree = {"id": "test", "tag": "div", "props": {}, "children": ["Simple route"]}
        
        result = generate_route_with_registry(route, initial_tree)
        
        # Check basic structure
        assert 'import { ReactiveUIContainer } from "../ui-tree";' in result
        assert 'import { ComponentRegistryProvider } from "../ui-tree/component-registry";' in result
        ...
        assert "const componentRegistry: Record<string, ComponentType<any>> = {};" in result
    ...
    def test_route_with_components(self):
        ...
        initial_tree = {"id": "test", "tag": "div", "props": {}, "children": ["Route with components"]}
...
class TestGenerateRoutesConfig:
    ...
    def test_empty_routes_list(self):
        ...
        assert 'import { type RouteConfig, index, route } from "@react-router/dev/routes";' in result
        ...
        import_line = 'import { type RouteConfig, index, route } from "@react-router/dev/routes";'
...
{satisfies_line}'''
    ...
    def test_route_path_to_filename_conversion(self):
        ...
        assert 'route("/admin/user-management", "routes/admin_user_management.tsx"),' in result
...
class TestWriteGeneratedFiles:
    ...
    def test_write_files_to_temp_directory(self):
        ...
        @define_route("/test", components=["button"])
        def test_route():
            return div()[
                h1()["Test Route"],
                Button()["Click me"]
    ...
    def test_route_with_complex_ui_tree(self):
        ...
        @define_route("/complex", components=["counter", "card"])
        def complex_route():
...
class TestCodegenEdgeCases:
    ...
    def test_component_with_special_characters_in_path(self):
        ...
        assert 'import { SpecialComponent } from "./components/Special@Component";' in result
    ...
    def test_json_serialization_safety(self):
        ...
        assert '"arrayProp"' in result and '1' in result and '2' in result and '3' in result
        assert '"objectProp"' in result and '"nested": "value"' in result
        
        # Children array should handle mixed types
        assert 'text' in result and '123' in result and 'true' in result and 'null' in result
