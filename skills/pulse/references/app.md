...
| `shell_render_timeout` | `float` | `30.0` | How long a mount-less "shell" render (minted on a stale-render-id reconnect, only tells the client to reload) is kept after disconnect before being reaped (seconds) |
